      ...
      <div className=" bg-gray-900 h-[400px] w-full relative">
         <div className=" flex flex-col justify-center items-center absolute bottom-[80px] left-[36%]  md:bottom-[100px] md:left-[48%] lg:bottom-[100px] lg:left-[48%] gap-[5px]">
            ...
            <div className=" flex justify-center items-center gap-[20px] ">
               ...
               <a href="mailto:shreerambca1@gmail.com?subject=apply for me">
                  <MdEmail color="white" size={29} />
               </a>
            </div>
         </div>
         <div className=" text-white absolute bottom-[20px] left-[60px] md:bottom-[20px] md:left-[42.5%] lg:bottom-[20px] lg:left-[42.5%] flex justify-center items-center">Copyright<FaRegCopyright color="white" />2024 All rights reserved</div>
      </div>
   );
}
